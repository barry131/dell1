...
var touch = {
	...
	bodyroxh:function(){
		$('#sec_sixth').on('touchstart',function(evt){
			evt.preventDefault(); //阻止触摸时浏览器的缩放、滚动条滚动等
		})
	} 
}
...
$(function(){
	...
	$(".chat_bottom_btn").click(function(){
		$('#sec_third').hide();
		$('#sec_fourth').show();
		setTimeout(function(){
	...
	$(".chat_redpacket").click(function(){
		$('#sec_seventh').hide();
		$('#sec_eighth').hide();
	});
	$(".sharebot_tjhy").click(function(){
		$(".alert_yqhy").show();
	});
	$(".share_yh").click(function(){
		$("#alert_yhqsysm").hide();
	});
	$(".coupon_close").click(function(){
		$(this).parents(".coupon_wrap").hide();
	});
	$(".alert_yqhy").click(function(){
		$(this).hide();
	});
});
...
function shareCallBack(){
    $.ajax({
        ...
        data: {
            act : 'share',
            link : $('#wx-shareFriend').attr('data-link'),
        },
        dataType:'json',
